...
class HerbalScreen extends StatefulWidget {
  ...
  @override
  State<HerbalScreen> createState() => _HerbalScreenState();
}
...
class _HerbalScreenState extends State<HerbalScreen> {
  ...
  void initState() {
    ...
    provider?.getInfoLib("herbal", context);
              ...
              children: [
                ...
                Expanded(flex: 1, child: infoLibDataList?.isEmpty == true ? const Center(child: Text('No data available', textAlign: TextAlign.start, style: TextStyle(color: black, fontWeight: FontWeight.w400, fontSize: 14,),)): ListView.builder(
                  ...
                  itemBuilder: (ctx, position) {
                    ...
                    return InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => InfoDetailScreen(infoDetail: data!, isInfo: false,)));
                        },
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(flex: 9,child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('${data?.name}', textAlign: TextAlign.start, style: TextStyle(color: HexColor('219653'), fontWeight: FontWeight.w600, fontSize: 18,),
                                    maxLines: 2,
